...
part of 'employees_api_service.dart';
...
class _EmployeesApiService implements EmployeesApiService {
  _EmployeesApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<List<EmployeeModel>> fetchEmployees(
    ...
    final _options = _setStreamType<List<EmployeeModel>>(
    ...
    late List<EmployeeModel> _value;
    try {
      _value = _result.data!
  ...
  Future<EmployeeModel> fetchEmployeeById(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EmployeeModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Employees/${id}',
  ...
  Future<EmployeeResponseModel> updateEmployeeStatus(
    String id,
    UpdateEmployeeStatusRequestModel request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
