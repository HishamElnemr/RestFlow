...
class _NotificationsApiService implements NotificationsApiService {
  ...
  @override
  Future<NotificationListResponseModel> fetchNotifications() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<NotificationListResponseModel>(
    ...
    late NotificationListResponseModel _value;
    try {
      _value = NotificationListResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
